...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (ResolveInfo rInfo : list) {
            ...
            Log.w("======================", "");
            Log.w("Installed Applications",appInfo.loadIcon(pm).toString());

            //adicionando na lista o nome do apk, package name e o ícone do msm na lista
             apps.add(new AplicativoInstalado(
        ...
        gv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                //ao clicar em um aplicativo a snack bar irá apresentar o package name do msm
                Snackbar.make(view, apps.get(position).getPackageName(), Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
            }
        });
    }
